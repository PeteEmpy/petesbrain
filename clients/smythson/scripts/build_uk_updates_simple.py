#!/usr/bin/env python3
"""Build UK RSA updates by loading current state and preserving it"""

import json
import sys

print("Building UK RSA updates...")
print("Loading current state...")

with open('../data/uk_rsa_current_state.json', 'r') as f:
    current_state = json.load(f)

print(f"✓ Loaded {len(current_state)} UK RSAs")
...
output_file = '../data/uk_rsa_updates_full.json'
