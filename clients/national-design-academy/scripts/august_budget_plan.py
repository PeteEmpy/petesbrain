...
campaigns = [
    ...
    {"name": "NDA | UAE | Search | Interior Design Diploma No Target", "conversions": 7.50, "ytd_spend": 7185.15, "cpa": 958.02, "market": "International", "action": "REDUCE_70", "reason": "Very high CPA (£958), major reduction"},
    {"name": "NDA | P Max | Interior Design Diploma - USA/Canada 250", "conversions": 3.00, "ytd_spend": 2019.55, "cpa": 673.18, "market": "International", "action": "REDUCE_70", "reason": "High CPA (£673), major reduction"},
    {"name": "NDA | UAE | Search | Interior Design Degree No Target", "conversions": 2.00, "ytd_spend": 3493.10, "cpa": 1746.55, "market": "International", "action": "REDUCE_70", "reason": "Extremely high CPA (£1,747), major cut"},
    {"name": "NDA | OM/SA/UAE | Search | Landscape Design No Target", "conversions": 1.37, "ytd_spend": 908.38, "cpa": 663.05, "market": "International", "action": "REDUCE_70", "reason": "High CPA (£663), major reduction"},
    {"name": "NDA | Pro Curtain Making & Soft Furnishings Fast-Track I 2023", "conversions": 1.16, "ytd_spend": 906.96, "cpa": 781.86, "market": "UK", "action": "REDUCE_70", "reason": "High CPA (£782), major reduction"},
    {"name": "NDA | UK | Search | Curtain Making Courses No Target", "conversions": 1.00, "ytd_spend": 911.80, "cpa": 911.80, "market": "UK", "action": "REDUCE_70", "reason": "High CPA (£912), major reduction"},
    {"name": "NDA | UK | Search | Retail Design Degree No Target", "conversions": 1.00, "ytd_spend": 827.84, "cpa": 827.84, "market": "UK", "action": "REDUCE_70", "reason": "High CPA (£828), major reduction"},
    {"name": "NDA | BH/CY/KW | Search | Interior Design Degree No Target", "conversions": 1.00, "ytd_spend": 2108.53, "cpa": 2108.53, "market": "International", "action": "REDUCE_70", "reason": "Extremely high CPA (£2,109), major cut"},

    # VERY LOW PERFORMERS - PAUSE
    {"name": "NDA | P Max | Interior Design Degree - Oman/Saudi/Bahrain/Kuwait/Qatar", "conversions": 0.50, "ytd_spend": 1144.68, "cpa": 2289.36, "market": "International", "action": "PAUSE", "reason": "Only 0.5 conv, CPA £2,289"},
    {"name": "NDA | UK | Search | Interior Design Careers  No Target", "conversions": 0.15, "ytd_spend": 1825.03, "cpa": 12166.87, "market": "UK", "action": "PAUSE", "reason": "Only 0.15 conv, CPA £12,167"},
    {"name": "NDA | BH/IN/CYSI | Search | Landscape Design Course No Target", "conversions": 0.09, "ytd_spend": 903.66, "cpa": 10040.67, "market": "International", "action": "PAUSE", "reason": "Only 0.09 conv, CPA £10,041"},

    # ZERO PERFORMERS - PAUSE
    {"name": "NDA | EUR | Search | Landscape Design Courses 65", "conversions": 0.00, "ytd_spend": 0.12, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions"},
    {"name": "NDA | AT/FR/NL/MA/DE/SW | Search |  Landscape Design Diplomas No Target", "conversions": 0.00, "ytd_spend": 902.94, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions over 3 months"},
    {"name": "NDA | AT/FR/NL/MA/DE/SW | Search | Interior Design Diploma 250", "conversions": 0.00, "ytd_spend": 365.36, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions"},
    {"name": "NDA | Low Intl | Search | Retail Design Degree No Target", "conversions": 0.00, "ytd_spend": 768.21, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions"},
    {"name": "NDA | Low Intl | Search | Curtain Making Course No Target", "conversions": 0.00, "ytd_spend": 38.97, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions"},
    {"name": "NDA | IN | Search | Interior Design Degree No Target", "conversions": 0.00, "ytd_spend": 1414.79, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions despite £1,415 spend"},
    {"name": "NDA | P Max | Interior Design Degree - USA/Canada 250 Split", "conversions": 0.00, "ytd_spend": 908.95, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions"},
    {"name": "NDA | Search | Interior Design Degree - Oman/Saudi/Bahrain/Kuwait 175", "conversions": 0.00, "ytd_spend": 1943.60, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions despite £1,944 spend"},
    {"name": "NDA | Search | Interior Design Diploma - Bahrain/Cyprus/Kuwait+ 135", "conversions": 0.00, "ytd_spend": 1373.46, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions"},
    {"name": "NDA | P Max Reboot | Interior Design Diploma - MENA", "conversions": 0.00, "ytd_spend": 2017.12, "cpa": 0, "market": "International", "action": "PAUSE", "reason": "0 conversions despite £2,017 spend"},
]
...
for c in campaigns:
    ...
    elif c['action'] == 'REDUCE_70':
        c['new_spend'] = round(c['oct_spend'] * 0.3, 2)
        c['change_pct'] = -70
        c['saving'] = round(c['oct_spend'] - c['new_spend'], 2)
    elif c['action'] == 'PAUSE':
        c['new_spend'] = 0
...
# Header rows
writer.writerow(['NDA BUDGET REDUCTION PLAN - RETURN TO AUGUST LEVELS'])
...
action_order = {'PAUSE': 1, 'REDUCE_70': 2, 'REDUCE_50': 3, 'KEEP': 4}
...
action_groups = {
    ...
    'REDUCE_70': [c for c in campaigns if c['action'] == 'REDUCE_70'],
...
writer.writerow([])
writer.writerow(['Target Gap:', f"£{total_new - august_spend:,.2f}" if total_new > august_spend else 'TARGET MET ✓'])
