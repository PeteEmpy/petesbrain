#!/usr/bin/env python3
"""
Google Specifications Indexer

Generates master index.json for programmatic access to all specifications.
...
def build_index() -> Dict[str, Any]:
    ...
    print("=" * 60)
    print("  Google Specifications Indexer")
    print("=" * 60)
    print()
    ...
    for json_file in SPECS_ROOT.rglob("specifications/**/*.json"):
        ...
        if len(parts) >= 3:
            category = parts[0]  # google-ads, ga4, or rok-methodologies
            subcategory = parts[2]  # asset-groups, merchant-center, etc.
            filename = json_file.stem
            
            # Map category names
            if category == "rok-methodologies":
                category_key = "rok_methodologies"
            else:
    ...
    for category in ["google_ads", "ga4", "rok_methodologies"]:
