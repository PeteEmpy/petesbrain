...
class ClaudeCopywriter:
    ...
    def __init__(self, url: str, model: str = 'claude-3-haiku-20240307'):
        self.url = url
...
Return ONLY the JSON, no other text before or after."""
        ...
        try:
            ...
            print(f"API usage: {message.usage.input_tokens} input + {message.usage.output_tokens} output tokens = ${cost:.4f}", flush=True)
