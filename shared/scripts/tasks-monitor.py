...
MCP_SERVER_PATH = Path(__file__).parent.parent / "mcp-servers" / "google-tasks-mcp-server"
...
# Configuration
STATE_FILE = Path("/Users/administrator/Documents/PetesBrain/shared/data/tasks-state.json")
COMPLETIONS_FILE = Path("/Users/administrator/Documents/PetesBrain/shared/data/tasks-completed.json")
