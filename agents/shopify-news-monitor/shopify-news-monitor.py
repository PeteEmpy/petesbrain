...
STATE_FILE = PROJECT_ROOT / "data/state/shopify-news-state.json"
LOG_FILE = PROJECT_ROOT / "data/cache/shopify-news-monitor.log"
...
RSS_FEEDS = {
    ...
    "A Better Lemonade Stand": "https://www.abetterlemonadestand.com/feed/",
