#!/usr/bin/env python3
"""
Google Specifications Processor

Processes manual additions from Google rep emails/meetings.
...
LOG_FILE = PROJECT_ROOT / "data/cache/google-specs-processor.log"
...
def batch_process_files(file_contents: Dict[str, str]) -> List[Dict[str, Any]]:
    ...
    prompt = f"""Analyze these Google rep recommendations, meeting notes, or manual additions and extract specifications and best practices.
...
def process_inbox():
    ...
    log_message("=" * 60)
    log_message("Google Specifications Processor Started")
    log_message("=" * 60)
    
    # Collect files from inbox subdirectories
    inbox_subdirs = ["google-rep-emails", "meeting-notes", "manual-additions"]
    all_files = []
    ...
    for i in range(0, len(all_files), BATCH_SIZE):
        ...
        for item in extracted:
            ...
            category = item.get("category", "google-ads")
