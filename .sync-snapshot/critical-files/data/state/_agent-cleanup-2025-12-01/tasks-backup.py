...
def export_google_tasks():
    ...
    try:
        ...
        sys.path.insert(0, '/Users/administrator/Documents/PetesBrain.nosync/infrastructure/mcp-servers/google-tasks-mcp-server')
...
def upload_to_google_drive(archive_path, archive_name):
    ...
    try:
        ...
        import shutil
        backup_dir = Path('/Users/administrator/Documents/PetesBrain.nosync/_backups/tasks')
