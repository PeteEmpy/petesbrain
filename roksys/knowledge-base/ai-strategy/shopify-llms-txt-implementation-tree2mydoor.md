---
title: Implementing LLMS.txt and Agents.txt for AI Discovery on Shopify
source: 2025-10-31_collaber-ppc-chat-space-mention-hi-peter-empson-th.md
date_added: 2025-11-08
last_updated: 2025-11-08
tags: [llms-txt, ai-discovery, shopify-seo, tree2mydoor, press-coverage-impact]
source_type: email
---

## Summary

- Implementation guide for adding llms.txt and agents.txt files to Shopify stores using <link> tags in theme.liquid to overcome root directory restrictions
- Task assigned to Qamar Gulraiz to implement AI crawler discovery files for Tree2Mydoor Shopify store
- Discussion of significant performance spike on Olive Tree product driven by high-profile press coverage in large readership magazines
- Notable 76% CPC drop observed, potentially indicating competitor changes or increased direct traffic from press coverage

## Key Insights

- Shopify's root directory limitations require creative workarounds using HTML <head> <link> tags to signal AI crawlers about llms.txt and agents.txt file locations
- The LLMS.txt format is emerging technology with evolving best practices - ongoing monitoring required as standards develop
- Press coverage can drive significant direct traffic and impact PPC metrics (76% CPC reduction), making attribution and performance analysis more complex
- High-profile editorial coverage in magazines for Olive Tree products demonstrates successful PR strategy complementing paid advertising efforts
