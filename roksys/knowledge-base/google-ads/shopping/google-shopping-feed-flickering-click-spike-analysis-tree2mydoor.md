---
title: Google Shopping Feed Flickering Causing Click Spike & LLMS.txt Implementation for Shopify
source: 2025-10-30_collaber-ppc-chat-space-mention-thank-you-peter-em.md
date_added: 2025-11-08
last_updated: 2025-11-08
tags: [google-merchant-center, feed-management, stock-sync-issues, click-anomalies, llms-txt, ai-discovery, shopify, tree2mydoor]
source_type: email
---

## Summary

- Product 01090 (Olive Tree Gift) caused a 316% click spike on Oct 27-28 due to feed flickering - being removed and re-added 4 times on Oct 29th alone
- Google's algorithm treats repeatedly re-added products as 'new inventory' and gives them priority in auctions, causing massive click surges
- Root cause identified as stock synchronization issues causing the product to flicker in/out of Google Merchant Center feed multiple times per day
- Implemented LLMS.txt and agents.txt files in Shopify theme.liquid using <link> tags in <head> section to enable AI crawler discovery
- Enhanced tracking now enabled to catch feed flickering issues immediately going forward

## Key Insights

- Feed flickering is a critical issue that can cause dramatic performance anomalies - a single product generated 1,465 clicks in one day when flickering
- Google Shopping algorithm prioritizes products that appear 'new' to the feed, making feed stability essential for predictable performance
- Stock synchronization problems between e-commerce platforms and Google Merchant Center need immediate investigation when detected
- LLMS.txt implementation on Shopify requires workaround using <link> tags in theme.liquid since root directory file uploads aren't supported
- Proactive monitoring and enhanced tracking systems are essential for catching feed issues before they cause budget overspend
