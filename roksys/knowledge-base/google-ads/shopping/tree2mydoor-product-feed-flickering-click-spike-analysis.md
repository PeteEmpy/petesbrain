---
title: Tree2Mydoor Click Spike Analysis - Product Feed Flickering Issue
source: 2025-10-30_collaber-ppc-chat-space-mention-thank-you-peter-em_2.md
date_added: 2025-11-12
last_updated: 2025-11-12
tags: [merchant-center, product-feed, stock-issues, click-spike, shopify, ai-crawlers]
source_type: email
---

## Summary

- 316% click spike identified on October 27-28 for Tree2Mydoor campaigns
- Single product (Olive Tree Gift £28.99, ID 01090) generated 1,465 clicks on October 28
- Root cause: Product flickering in/out of Google Merchant Center feed due to stock synchronization issues
- Google's algorithm treats repeatedly re-added products as 'new inventory' with priority in auctions
- Discussion also includes implementation of llms.txt and agents.txt files in Shopify theme for AI crawler discovery

## Key Insights

- Product feed instability can cause massive unintended click surges due to Google's 'new inventory' prioritization
- Stock synchronization issues between e-commerce platform and Merchant Center can trigger algorithmic responses
- Enhanced tracking implemented to catch feed flickering issues immediately
- Implementation of llms.txt and agents.txt files for AI system discovery is emerging best practice for e-commerce sites
...
*Original file: 2025-10-30_collaber-ppc-chat-space-mention-thank-you-peter-em_2.md*
