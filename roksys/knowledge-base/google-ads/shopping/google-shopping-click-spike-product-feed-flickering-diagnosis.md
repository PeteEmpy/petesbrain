---
title: Google Shopping Click Spike Investigation: Product Feed Flickering Issue & LLMS.txt Implementation
source: 2025-10-30_collaber-ppc-chat-space-mention-thank-you-peter-em.md
date_added: 2025-11-08
last_updated: 2025-11-08
tags: [google-merchant-center, product-feed-issues, click-anomalies, inventory-synchronization, llms-txt-implementation]
source_type: email
---

## Summary

- Investigation revealed 316% click spike on October 27-28 caused by product ID 01090 (Olive Tree Gift) flickering in/out of Google Merchant Center feed
- Product was removed and re-added 4 times on October 29th alone, causing Google's algorithm to treat it as 'new inventory' each time and prioritize it in auctions
- Root cause identified as stock synchronization issues causing rapid in/out of stock status changes
- Enhanced tracking implemented to catch future feed issues immediately
- Secondary discussion on implementing LLMS.txt and agents.txt files in Shopify theme for AI crawler discovery

## Key Insights

- Feed flickering causes Google Shopping to treat products as new inventory, triggering aggressive bidding and unexpected click volume spikes
- Stock synchronization issues between e-commerce platforms and Google Merchant Center can create costly performance anomalies that appear as sudden campaign changes
- Product ID 01090 is a high-performer when stable (1,465 clicks in single day), indicating strong demand that should be capitalized on with consistent availability
- Shopify's root directory restrictions require using <link> tags in theme.liquid to properly signal LLMS.txt and agents.txt files to AI crawlers
- Proactive monitoring and enhanced tracking systems are essential for catching Merchant Center feed issues before they impact campaign spend
...
*Original file: 2025-10-30_collaber-ppc-chat-space-mention-thank-you-peter-em.md*
