---
title: Product Feed Flickering Causes 316% Click Spike - Tree2MyDoor Diagnosis
source: 2025-10-30_collaber-ppc-chat-space-mention-thank-you-peter-em.md
date_added: 2025-11-12
last_updated: 2025-11-12
tags: [shopping-feed, merchant-center, product-feed-issues, click-anomaly, llms-txt, shopify]
source_type: email
---

## Summary

- Qamar Gulraiz (Collaber agency) identified root cause of 316% click increase on October 27-28
- Single product (Olive Tree Gift, £28.99, Product ID 01090) generated 1,465 clicks on October 28 alone
- Product flickering in/out of Google Merchant Center feed multiple times daily since October 25 (4 times on October 29)
- Google algorithm treats repeatedly removed/re-added products as 'new inventory' with auction priority
- Root cause likely stock synchronization issues in inventory management system
- Separate discussion about implementing llms.txt format in Shopify for AI crawler discovery

## Key Insights

- Feed stability is critical - product flickering can artificially trigger Google's new inventory priority algorithm, causing uncontrolled spend
- Single product issues can dramatically impact entire campaign performance and budget consumption
- Stock synchronization between e-commerce platform and Merchant Center requires monitoring and alerts
- Enhanced tracking implementation mentioned suggests proactive monitoring capability being established
- Advanced discussion of llms.txt implementation shows forward-thinking approach to AI discoverability for e-commerce content
- Detailed technical guidance on Shopify theme.liquid modification demonstrates expertise in cross-platform optimization
